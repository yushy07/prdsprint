...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        try {
          ...
          console.warn('WebGL renderer creation failed in Hyperspeed:', err);
          this.renderer = null;
          this.disposed = true;
          return;
        }
    ...
    try {
      ...
      console.warn('Hyperspeed App initialization failed:', err);
    }
  ...
  }, [JSON.stringify(effectOptions, (k, v) => typeof v === 'function' ? 'fn' : v)]);
